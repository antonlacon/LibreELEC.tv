...
builds_all = [
    ...
    ['Amlogic', 'AMLGX', 'arm', 'bananapi-m2-pro'],
    ['Amlogic', 'AMLGX', 'arm', 'bananapi-m2s'],
    ['Amlogic', 'AMLGX', 'arm', 'bananapi-m5'],
    ['Amlogic', 'AMLGX', 'arm', 'box'],
    ['Amlogic', 'AMLGX', 'arm', 'khadas-vim'],
    ['Amlogic', 'AMLGX', 'arm', 'khadas-vim2'],
    ['Amlogic', 'AMLGX', 'arm', 'khadas-vim3'],
    ['Amlogic', 'AMLGX', 'arm', 'khadas-vim3l'],
    ['Amlogic', 'AMLGX', 'arm', 'lafrite'],
    ['Amlogic', 'AMLGX', 'arm', 'lepotato'],
    ['Amlogic', 'AMLGX', 'arm', 'nanopi-k2'],
    ['Amlogic', 'AMLGX', 'arm', 'odroid-c2'],
    ['Amlogic', 'AMLGX', 'arm', 'odroid-c4'],
    ['Amlogic', 'AMLGX', 'arm', 'odroid-hc4'],
    ['Amlogic', 'AMLGX', 'arm', 'odroid-n2'],
    ['Amlogic', 'AMLGX', 'arm', 'radxa-zero'],
    ['Amlogic', 'AMLGX', 'arm', 'radxa-zero2'],
    ['Amlogic', 'AMLGX', 'arm', 'wetek-core2'],
    ['Amlogic', 'AMLGX', 'arm', 'wetek-hub'],
    ['Amlogic', 'AMLGX', 'arm', 'wetek-play2'],
    ...
    ['Rockchip', 'RK3328', 'arm', 'a1'],
    ['Rockchip', 'RK3328', 'arm', 'roc-cc'],
    ['Rockchip', 'RK3328', 'arm', 'rock64'],
    ['Rockchip', 'RK3399', 'arm', 'hugsun-x99'],
    ['Rockchip', 'RK3399', 'arm', 'khadas-edge'],
    ['Rockchip', 'RK3399', 'arm', 'nanopc-t4'],
    ['Rockchip', 'RK3399', 'arm', 'nanopi-m4'],
    ['Rockchip', 'RK3399', 'arm', 'orangepi'],
    ['Rockchip', 'RK3399', 'arm', 'roc-pc'],
    ['Rockchip', 'RK3399', 'arm', 'roc-pc-plus'],
    ['Rockchip', 'RK3399', 'arm', 'rock-pi-4'],
    ['Rockchip', 'RK3399', 'arm', 'rock-pi-4-plus'],
    ['Rockchip', 'RK3399', 'arm', 'rock-pi-n10'],
    ['Rockchip', 'RK3399', 'arm', 'rock960'],
    ['Rockchip', 'RK3399', 'arm', 'rockpro64'],
    ['Rockchip', 'RK3399', 'arm', 'sapphire'],
]
# not building
